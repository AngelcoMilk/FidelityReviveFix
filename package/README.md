...
- 兼容 [REPOFidelity](https://thunderstore.io/c/repo/p/Vippy/REPOFidelity/)，用于修复它与其他复活类 mod 的时机冲突问题。
...
REPOFidelity 兼容保护会在收到原版复活 RPC 后执行，不会延迟主机的瞬间复活触发。
...
- Includes a compatibility patch for [REPOFidelity](https://thunderstore.io/c/repo/p/Vippy/REPOFidelity/) to fix timing conflicts with other revive mods.
...
The REPOFidelity compatibility protection runs after the vanilla revive RPC is received. It does not delay the host's instant revive trigger.
